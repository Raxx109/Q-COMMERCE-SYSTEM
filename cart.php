    ...
    $ftotal = 0;
        try {
            ...
            foreach ($row as $r){
                ...
                echo '
                        <tr><td> <img src = "img/'.$r['img'].'" style="width: 50px; height: 50px;"></img> &nbsp; '.$r['name'].' </td>
						<td> ₱ '.$r['price'].' </td>
						<td> <a href = "removeitem.php?item='.$r['itemID'].'&quantity='.$r['quantity'].'"style = "border-color: red; color: red;"><i class="fa fa-minus"></i></a> '.$r['quantity'].' <a href="addcart.php?item='. $r['itemID'] .'" style = "border-color: green; color: green;"><i class="fa fa-plus"></i></a> </td> 
						<td> ₱ '.$total.'</td>
						<td><a href = "delitem.php?item='. $r['itemID'] .'"><i class="fa fa-times text-danger"></i></a></td></tr>
                ';
				$ftotal +=  $total;
				}
        } catch (Exception $e) {
                        ...
                        <div class="bg-light rounded">
                            <div class="p-4">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    <h5 class="mb-0 me-4">Subtotal: ₱ <?php echo $ftotal;?></h5>
                                    <!--dito yung total-->
                                </div>
                                <div class="d-flex justify-content-between">
                                    <h5 class="mb-0 me-4">Shipping: ₱ 50</h5>
                                    <div class="">
                                        <!-- dito yung total -->
                                    </div>
                                </div>
