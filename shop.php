...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
                <h1 class="mb-4"> Quezon's Local Flavors</h1>
                <div class="row g-4">
                    <div class="col-lg-12">
                        <div class="row g-4">
                            <div class="col-xl-3">
                        ...
                        <div class="row g-4">
                                            ...
                                            <ul class="list-unstyled fruite-categorie">
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Real</a>
                                                        <span>(3)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Tayabas</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Sariaya</a>
                                                        <span>(2)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Lucban</a>
                                                        <span>(8)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Agdangan</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Atimonan</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Buenavista</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Burdeos</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Candelaria</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Infanta</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Jomalig</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="d-flex justify-content-between fruite-name">
                                                        <a href="#"><i class="fas fa-location-arrow me-2"></i>Pagbilao</a>
                                                        <span>(5)</span>
                                                    </div>
                                                </li>
                                            </ul>
                            ...
                            <div class="col-lg-9">
                                <div class="row g-4 justify-content-center" id = "pg1">
                                ...
                                <div class="row g-4 justify-content-center" id = "pg2">
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                ...
                                <div class="row g-4 justify-content-center" id = "pg3">
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                        ...
                                        <div class="rounded position-relative fruite-item">
                                            ...
                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                ...
                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                    ...
                                                    <a href="additem.php?item=120" class="btn border border-secondary rounded-pill px-3 text-primary"><i class="fa fa-shopping-bag me-2 text-primary"></i> Add to cart</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-4 justify-content-center" id = "pg4">
                                    <div class="col-md-6 col-lg-6 col-xl-4">
                                        <div class="rounded position-relative fruite-item">
                                            <div class="fruite-img">
                                    ...
                                    <div class="col-12">
                                        <div class="pagination d-flex justify-content-center mt-5">
                                            <a href="#" onclick = "showpg1()" id="bpg1" class="rounded">1</a>
                                            <a href="#" onclick = "showpg2()" id="bpg2" class="rounded">2</a>
                                            <a href="#" onclick = "showpg3()" id="bpg3" class="rounded">3</a>
                                            <a href="#;" onclick = "showpg4()" id="bpg4" class="rounded">4</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        var page4 = document.getElementById('pg4');
        var page5 = document.getElementById('pg5');
        var page6 = document.getElementById('pg6');
        var page7 = document.getElementById('pg7');
        var page8 = document.getElementById('pg8');
        var bpage1 = document.getElementById('bpg1');
        var bpage2 = document.getElementById('bpg2');
        var bpage3 = document.getElementById('bpg3');
        var bpage4 = document.getElementById('bpg4');
        var bpage5 = document.getElementById('bpg5');
        var bpage6 = document.getElementById('bpg6');
        var bpage7 = document.getElementById('bpg7');
        var bpage8 = document.getElementById('bpg8');

        function showpg1(){
        /* mga sirang javascript aayusin pa
            bpage2.classList.remove("active rounded");
            bpage2.classList.add("rounded");
            bpage3.classList.remove("active rounded");
            bpage3.classList.add("rounded");
            bpage4.classList.remove("active rounded");
            bpage4.classList.add("rounded");
            bpage5.classList.remove("active rounded");
            bpage5.classList.add("rounded");
            bpage6.classList.remove("active rounded");
            bpage6.classList.add("rounded");
            bpage7.classList.remove("active rounded");
            bpage7.classList.add("rounded");
            bpage8.classList.remove("active rounded");
            bpage8.classList.add("rounded");
        */
        ...
        function showpg2(){
            /*
            bpage1.classList.remove("active rounded");
            bpage1.classList.add("rounded");
            bpage2.classList.remove("rounded");
            bpage2.classList.add("active rounded");
            bpage3.classList.remove("active rounded");
            bpage3.classList.add("rounded");
            bpage4.classList.remove("active rounded");
            bpage4.classList.add("rounded");
        ...
        function showpg3(){
            ...
            bpage1.classList.add("rounded");
            bpage2.classList.remove("active rounded");
            bpage2.classList.add("rounded rounded");
            bpage3.classList.remove("rounded");
            bpage3.classList.add("active rounded");
            bpage4.classList.remove("active rounded");
            bpage4.classList.add("rounded");
            bpage5.classList.remove("active rounded");
            bpage5.classList.add("rounded");
        ...
        function showpg4(){
            ...
            bpage3.classList.remove("active rounded");
            bpage3.classList.add("rounded");
            bpage4.classList.remove("rounded");
            bpage4.classList.add("active rounded");
            bpage5.classList.remove("active rounded");
            bpage5.classList.add("rounded");
            bpage6.classList.remove("active rounded");
            bpage6.classList.add("rounded");
        ...
        function showpg5(){
            ...
            bpage4.classList.remove("active rounded");
            bpage4.classList.add("rounded");
            bpage5.classList.remove("rounded");
            bpage5.classList.add("active rounded");
            bpage6.classList.remove("active rounded");
            bpage6.classList.add("rounded");
            bpage7.classList.remove("active rounded");
            bpage7.classList.add("rounded");
        ...
        function showpg6(){
            ...
            bpage5.classList.remove("active rounded");
            bpage5.classList.add("rounded");
            bpage6.classList.remove("rounded");
            bpage6.classList.add("active rounded");
            bpage7.classList.remove("active rounded");
            bpage7.classList.add("rounded");
            bpage8.classList.remove("active rounded");
            bpage8.classList.add("rounded");
